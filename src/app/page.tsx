...
function DashboardContent() {
    ...
    return (
        <div className="min-h-screen font-sans text-white">
            ...
            {/* MAIN CONTENT */}
            <main className="mx-auto w-full max-w-[1440px] flex-1 px-6 py-8 lg:px-12 bg-transparent text-white">
                {viewMode === 'SUBSCRIPTION' ? (
                    ...
                    <>
                        ...
                        <div className="mb-12 flex flex-col items-center text-center">
                            <h1 className="font-serif-heading text-4xl font-black text-white lg:text-6xl mb-4">Our Full Menu</h1>
                            <p className="max-w-xl text-gray-300 text-lg">Experience the finest South Indian flavors, prepared fresh with traditional techniques and local ingredients.</p>

                            <div className="mt-6 flex gap-4 text-xs font-bold uppercase tracking-wider text-gray-200">
                                <span className="flex items-center gap-2"><span className="h-2 w-2 rounded-full bg-[#14b84b]"></span> 100% Fresh</span>
                            ...
                            <div className="relative mt-8 lg:hidden w-full max-w-md">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-full border border-white/20 bg-black/40 py-2 pl-9 pr-4 text-sm focus:ring-1 focus:ring-[#14b84b] outline-none text-white placeholder-gray-400"
                                />
                            </div>
                        </div>

                        {/* CATEGORY NAV */}
                        <div className="sticky top-[86px] z-40 mb-12 -mx-6 px-6 py-2 bg-[#14b84b]/10 border-b border-white/10 backdrop-blur-md">
                            ...
                            {availableCategories.map(category => (
                                <section key={category} id={category.toLowerCase().replace(/\s+/g, '-')} className="scroll-mt-32">
                                    <div className="flex items-center gap-6 mb-12">
                                        <h2 className="font-serif-heading text-3xl md:text-4xl font-black text-white tracking-tight">{category}</h2>
