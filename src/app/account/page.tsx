        ...
        <div className="min-h-screen bg-[#FFF8F0] pb-24 md:pb-8">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-2xl font-bold text-[#5C3A1A]">My Account</h1>
                    <button
                ...
                <div className="max-w-md mx-auto p-4 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            onClick={async () => {
                                // Open feedback - redirect to home with feedback modal
                        ...
                        <button
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    await enableNotifications({ ...user, id: user.id });
                                } catch (e) {
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-xs text-gray-500">Get updates on your orders</p>
                                </div>
                            </div>
                            <ChevronRightIcon className="text-gray-400" width={20} height={20} />
                        </button>
